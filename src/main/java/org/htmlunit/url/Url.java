 ...
 */
package org.htmlunit.url;

import java.util.List;

import org.htmlunit.url.impl.UrlImpl;

/**
 * This is the main interface of the project. It closely follows
 * <a href="https://url.spec.whatwg.org/#url-class">the URL interface defined by
 * the WhatWg specification</a>.<br>
 * <br>
 * To get an instance of a URL you can:
 * <ul>
 * <li>Create a blank new url by calling UrlBuilder.create()</li>
 * <li>Create a url from a string url by calling
 * UrlBuilder.create("http://www.myurl.com")</li>
 ...
 * <li>Create a url from a string url and a base Url as well as an error handler
 * by calling UrlBuilder.create("http://www.myurl.com",
 * "http://www.mybaseurl.com", error -&gt; {// do something with the
 * error})</li>
 * </ul>
 *
...
public interface Url {
     ...
     */
    static boolean canParse(final String url) {
     ...
     * @return true if the url can be parsed, false otherwise
     */
    static boolean canParse(final String url, final String baseUrl) {
        try {
            create(url, baseUrl);
            return true;
        }
     ...
     */
    static Url create(final String input) {
     ...
     * @exception ValidationException if the parse returns a failure
     */
    static Url create(final String input, final String baseUrl) {
    ...
    /**
     * Return a collection of validation errors reported when parsing the raw url
     * and/or setting properties Note that this method is not explicitly specified
