 ...
 * <a href="https://url.spec.whatwg.org/#interface-urlsearchparams">the
 * URLSearchParams interface defined by the WhatWg specification</a>. <br>
 *
 * Although the spec support a public constructor, the current implementation
...
public interface UrlSearchParams {
    ...
    /**
     * Delete all parameter name-value pairs whose name and value match the given.
     * name and value
     *
     * @param name  the parameter name
     * @param value the parameter value
    ...
    /**
     * Return whether there is a name-value pair matching the given parameter name
     * and value.
     *
     * @param name  the parameter name
     * @param value the parameter value
    ...
    /**
     * If this list contains any name-value pair whose name matches the given name,
     * then set the value of the first item to the given value and remove others
     * values. Otherwise, append the given name and value to the list
     *
     * @param name  the parameter name
     * @param value the parameter value
     * @return a reference to this to support a fluent api
    ...
    /**
     * Return the number of parameters. The size getter steps are to return this’s
     * list’s size.
     *
    ...
    /**
     * Sort all name-value pairs by their names. The relative order between
